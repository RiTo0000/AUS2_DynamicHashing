...
public class App {
    ...
    public boolean addProperty(Property property) {
        ...
        property.setLands(landsUnderProp);
        
        //do vsetkych najdenych parciel musim pridat aj ze na nich stoji tato (nova) nehnutelnost
        for (Land land : landsUnderProp) {
            if (!land.addProperty(property)) {
                return false; //nepodarilo sa pridat nehnutelnost na parcelu
            }
        }
    ...
    public boolean createProperty(Area space, int regNumber, String description) {
        Property property = new Property(space, regNumber, description);
    ...
    public void generateObject(boolean generateProperties, int count) {
